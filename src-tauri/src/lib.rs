...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::license::verify_license_remote,
            commands::license::get_license_server_url,
            commands::license::activate_license,
            commands::license::remove_license,
            commands::license::replace_license_binding,
            ...
            commands::decompile::resolve_unique_out_dir,
            ...
            commands::adb::adb_app_info_lite,
            commands::adb::adb_app_icon,
            commands::adb::adb_install_apks,
            commands::adb::adb_uninstall,
            commands::adb::adb_apk_paths,
            commands::adb::adb_pull_apk_for_tool,
            commands::adb::adb_export_apks,
            commands::adb::adb_force_stop,
            commands::adb::adb_reboot,
            commands::adb::adb_shutdown,
            commands::adb::adb_recovery_info,
            commands::adb::adb_sideload,
            commands::fastboot::fastboot_devices,
            commands::fastboot::fastboot_reboot,
            commands::fastboot::fastboot_get_info,
            commands::fastboot::fastboot_oem_device_info,
            ...
            commands::adb::screenshot_pull_to_cache,
            commands::adb::screenshot_save_from_cache,
            commands::adb::screenshot_discard_cache,
            commands::adb::is_device_rooted,
            commands::adb::adb_logcat_capture,
            commands::adb::adb_logcat_pull,
            commands::adb::adb_system_info,
            commands::adb::adb_system_info_via_agent,
        ])
        .setup(|_app| {
